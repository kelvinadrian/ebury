...
import com.ebury.cadastrocliente.validation.annotations.enderecoexterior.ValidacaoEnderecoExteriorCidade;
...
public class EnderecoExteriorCidadeValidator implements FieldValidator {
    ...
    public ValidationResult validate(Field field, Object value, String fieldPath) {
        if (field.getAnnotation(ValidacaoEnderecoExteriorCidade.class) == null) {
