...
import com.ebury.cadastrocliente.validation.annotations.endereco.ValidacaoEnderecoPreferencial;
...
public class EnderecoPreferencialValidator implements FieldValidator {
    ...
    public ValidationResult validate(Field field, Object value, String fieldPath) {
        if (field.getAnnotation(ValidacaoEnderecoPreferencial.class) == null) {
