...
import com.ebury.cadastrocliente.validation.annotations.socioacionista.ValidacaoSocioAcionistaTipoDeIdentificacao;
...
public class SocioAcionistaTipoDeIdentificacaoValidator implements FieldValidator {
    ...
    public ValidationResult validate(Field field, Object value, String fieldPath) {
        if (field.getAnnotation(ValidacaoSocioAcionistaTipoDeIdentificacao.class) == null) {
