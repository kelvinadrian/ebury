...
import com.ebury.cadastrocliente.validation.annotations.documentos.ValidacaoDocumentosIdsDosArquivos;
...
public class DocumentosIdsDosArquivosValidator implements FieldValidator {
    ...
    public ValidationResult validate(Field field, Object value, String fieldPath) {
        if (field.getAnnotation(ValidacaoDocumentosIdsDosArquivos.class) == null) {
