...
import com.ebury.cadastrocliente.validation.annotations.socioacionista.ValidacaoSocioAcionistaVigenciaFinal;
...
public class SocioAcionistaVigenciaFinalValidator implements FieldValidator {
    ...
    public ValidationResult validate(Field field, Object value, String fieldPath) {
        if (field.getAnnotation(ValidacaoSocioAcionistaVigenciaFinal.class) == null) {
